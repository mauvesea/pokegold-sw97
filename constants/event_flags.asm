...
; Johto story events
	...
	const EVENT_TEALBURG_BLUE
	const EVENT_MUSIC_FADEOUT
...
; Unused: next 15 events
    const EVENT_OAK_IN_SILENT_LAB_FRONT
    const EVENT_OAK_IN_SILENT_LAB_BACK
    const EVENT_RIVAL_IN_SILENT_LAB_FRONT
    const EVENT_RIVAL_IN_SILENT_LAB_BACK
    const EVENT_BLUE_LAB_WALK_UP
    const EVENT_BLUE_LAB_FRONT
    const EVENT_POPULATE_LAB
...
; Phone events
	...
	const EVENT_TALKED_TO_KEN_ONCE
