...
; wToolgearClockFlags::
DEF TOOLGEAR_CLOCK_DIRTY_F        EQU 0
DEF TOOLGEAR_CLOCK_TEXTBOX_F      EQU 1
DEF TOOLGEAR_CLOCK_PENDING_SHOW_F EQU 2
DEF TOOLGEAR_CLOCK_RENDERED_F     EQU 3
DEF TOOLGEAR_CLOCK_VISIBLE_F      EQU 4
DEF TOOLGEAR_CLOCK_WINDOW_Y       EQU $80 ; SCREEN_HEIGHT_PX - 2 * TILE_WIDTH
...
; wSkateboardMovementState
DEF SKATEBOARD_MOVEMENT_NONE           EQU 0
DEF SKATEBOARD_MOVEMENT_PENDING_BOUNCE EQU 1
DEF SKATEBOARD_MOVEMENT_FINISH_BOUNCE  EQU 2

; wPokemonFollowerFlags
DEF POKEMON_FOLLOWER_WARP_PENDING_F EQU 0
DEF POKEMON_FOLLOWER_SCRIPTED_F     EQU 1
DEF POKEMON_FOLLOWER_PREV_ENV_SHIFT EQU 2
DEF POKEMON_FOLLOWER_PREV_ENV_MASK  EQU %00011100
DEF POKEMON_FOLLOWER_CONNECTION_FRAME_F EQU 5
